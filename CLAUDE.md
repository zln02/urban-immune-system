...
> **중간발표: 2026-05-07** (4/30 → 5/7 연기) · **최종: 2026-06 초** · 현 baseline **F1=0.882 / Recall=0.837 (gate ON) / Recall_no_gate=0.904 / Precision=0.949 / FAR=0.206 (gate ON, 게이트 OFF=0.602, 게이트 효과 −65.8%) / Lead 6.47주 / MCC=0.595 / Balanced Acc=0.816 / AUPRC=0.973** (17지역 walk-forward 실측, `analysis/outputs/backtest_17regions.json`).
...
| 검증 결과 | **F1-Score 0.80 이상** + **FAR 0.30 미만** 유지 (현 baseline: F1=0.882 / Recall 0.904→0.837 / FAR 0.602→0.206 gate ON, 게이트 효과 −65.8% FAR·−7.4% Recall) |
