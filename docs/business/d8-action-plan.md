...
| 4 | 데모 백업 영상 인코딩 | 데모 | 1일 | 정욱현 |
| 5 | S07E 본문 복귀 | 슬라이드 | 5분 | 자동 완료 |
| 6 | 데모 시나리오 동선 | 발표 | 1일 | 박진영·정욱현 |
...
├── demo_url.txt                  # http://REDACTED-HOST:3000/dashboard
...
1. **0:00~0:30** — 대시보드 진입 (`http://REDACTED-HOST:3000/dashboard`)
...
- 정욱현: 노트북 좌측 모니터 — 슬라이드
- 정욱현: 노트북 우측 모니터 — `http://REDACTED-HOST:3000/dashboard`
