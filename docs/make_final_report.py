...
team_data = [
    ...
    ("2", "○○○○○○", "박진영", "PM·ML Lead / 전체 아키텍처 총괄, XGBoost·TFT·Autoencoder, RAG, 발표자료"),
    ("3", "○○○○○○", "이우형", "Data Engineer / L1·L2·L3 수집기, Kafka 파이프라인, KOWAS Selenium 자동화"),
    ("4", "○○○○○○", "김나영", "Frontend / Next.js 대시보드, Deck.gl 지도, SSE 경보 시각화, PDF 리포트"),
    ("5", "○○○○○○", "박정빈", "DevOps·QA / CI·K8s·systemd, Docker 보안, pytest 단위 113건+통합 19건"),
]
...
for b in [
    ...
    "Phase 4: ISMS-P 풀 점검, 조달청 혁신제품 신청, KDCA·서울시·WHO 협력 파일럿 기관 확보 (캡스톤 이후)",
    "외부 전문가 자문 30인 검증 결과 반영 후 성능 지표 재보정 및 국제 학술지 투고",
    "감염병 조기경보 시스템 방법론 특허 출원 완료 (산학협력단 발명신고서 제출 완료)",
    "1개 추가 병원체(노로바이러스 또는 RSV) 또는 추가 국가 확장 시연 (캡스톤 평가 4번째 기준 대응)",
]:
    add_bullet(doc, b)
