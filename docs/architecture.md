...
pipeline/collectors/   docker-compose:           ml/                 frontend/
 ...
 ├ wastewater     ─┼─→  │   uis.layer{1,2,3}      │   F1=0.841        App Router)
...
| 모델 | 학습일 | 위치 | 상태 |
|---|---|---|---|
| XGBoost (앙상블 주모델) | 2026-04-29 | `ml/checkpoints/xgb_best.joblib` | ✅ F1=0.841 / Recall=0.768 / FAR=0.162 (17지역 walk-forward, gap 4주 5-fold) |
