...
**작성자**: 박진영 (PM / ML Lead)  
**수신**: 이경준(Backend) · 김나영(Frontend) · 박정빈(DevOps/QA)
...
| Infra / QA | 박정빈 | 70% | 커버리지 39%(목표 70%), systemd 미기동, K8s ingress 없음 |
...
팀원 5명 전원이 서명해야 한다. 아래 항목을 문서로 작성한다.
...
발명자:
  ...
  2. 이경준 (동신대학교 AI학과 / Backend)
  3. 이우형 (동신대학교 AI학과 / Data Engineer)
  4. 김나영 (동신대학교 AI학과 / Frontend)
  5. 박정빈 (동신대학교 AI학과 / DevOps·QA)

발명의 요약:
  약국 OTC 구매량·하수 바이러스 농도·인터넷 검색 트렌드 등
  3계층 비의료 신호를 XGBoost+Autoencoder로 앙상블하여
  임상 확진 보고보다 평균 6.47주 선행하는 감염병 조기경보를 발령.
...
공지 경위:
  ...
  3. 2026-05-07 : 동신대학교 캡스톤디자인 중간발표
...
#### Step 3. KIPRIS 선행기술 조사 — 2주 이내 (박정빈 담당)
...
2. 내용: "캡스톤 프로젝트 자문 요청 — 모델 역학적 타당성 검토"
