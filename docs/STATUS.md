...
> 마지막 갱신: 2026-05-07 · 중간발표 당일 기준

## Baseline 성능 (17지역 walk-forward 실측)

| 지표 | 값 | 비고 |
|------|----|------|
| F1-Score | **0.882** | gate ON |
| Recall | **0.837** (gate ON) / 0.904 (gate OFF) | |
| Precision | **0.949** | |
| FAR | **0.206** (gate ON) / 0.602 (gate OFF) | 게이트 효과 −65.8% FAR |
...
| 검증 결과 | F1 ≥ 0.80 + FAR ≤ 0.30 | ✅ F1=0.882 / FAR=0.206 |
