...
> "약국 OTC 1~2주 선행. 하수 바이오마커 **2~3주 선행** (바이러스 직접 측정·가장 객관적 지표). 검색 트렌드 1~2주 선행.
...
> F1 0.907 · Precision 0.940 · Recall 0.882 · AUPRC 0.973 · **오경보율 0.250** — 모두 캡스톤 기준 F1≥0.80 / FAR<0.30 충족.
