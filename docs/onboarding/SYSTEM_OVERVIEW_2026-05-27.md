...
**비의료(non-clinical) 신호 3계층을 융합해 감염병을 임상 신고보다 평균 6.76주 선행 탐지하는 B2G 조기경보 SaaS 프로토타입.**
...
- 검증: 17개 시·도 walk-forward 백테스트, **F1 0.907 / Recall 0.882 / FAR 0.250(gate ON) / Lead 6.76주**
