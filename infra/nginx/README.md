...
```bash
ssh -L 8080:127.0.0.1:8080 wlsdud5035@34.47.113.176   # kafka-ui
ssh -L 5432:127.0.0.1:5432 wlsdud5035@34.47.113.176   # TimescaleDB
ssh -L 6333:127.0.0.1:6333 wlsdud5035@34.47.113.176   # Qdrant
```
