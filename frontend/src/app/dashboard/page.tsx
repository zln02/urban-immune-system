      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <span>{t.header_sync} · 09:28 KST</span>
          </div>
          <button
            type="button"
      ...
      >
        ...
        >
          ...
          <KpiCard
            ...
            tone="safe"
            sparkData={mockSeries.pharmacy.slice(-20)}
        ...
        >
          ...
          >
            <LayerCard
              ...
              sub={t.layer_pharmacy_sub}
              data={mockSeries.pharmacy.slice(-30)}
              value={mockSeries.pharmacy[mockSeries.pharmacy.length - 1]}
              change={18.2}
            ...
            <LayerCard
              ...
              sub={t.layer_search_sub}
              data={mockSeries.search.slice(-30)}
              value={mockSeries.search[mockSeries.search.length - 1]}
              change={12.4}
